...
st.set_page_config(
    page_title="E2E BY SAURAV MESSI",
    page_icon="",
    layout="wide",
...
ADMIN_PASSWORD = "SAURAV_MESSI@@1"
WHATSAPP_NUMBER = "+918586049742"
...
def send_whatsapp_message(user_name, approval_key):
    message = f" HELLO SAURAV MESSI SIR PLEASE \nMy name is {user_name}\nPlease approve my key:\n {approval_key}"
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f""" SAURAV MESSI SIR PLEASE 
My name is {username}
Please approve my key:
 {user_key}""")
...
def login_page():
    ...
    <div class="main-header">
        <img src="https://i.ibb.co/5W1QW4zH/1753900515862.jpg" class="prince-logo">
        <h1>FB DIRECTOR MESSI OFFLINE E2EE </h1>
...
def main_app():
    st.markdown('<div class="main-header"><img src="https://i.ibb.co/5W1QW4zH/1753900515862.jpg" class="prince-logo"><h1>FB DIRECTOR MESSI E2E OFFLINE</h1><p>səvən bıllıon smıləs ın ʈhıs world buʈ ɣours ıs mɣ fαvourıʈəs___</p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">Made with  by Saurav Messi | � 2026-27</div>', unsafe_allow_html=True)
